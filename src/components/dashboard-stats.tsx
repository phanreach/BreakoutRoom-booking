      ...
      <div className="flex gap-4 overflow-x-auto px-6 lg:px-8 pb-2 scrollbar-hide snap-x snap-mandatory scroll-smooth overscroll-x-contain">
        {stats.map((card) => {
          ...
          return (
            <div
              key={card.id}
              className="snap-center relative border border-gray-200 bg-white rounded-2xl shadow-md transition-all duration-300 p-6 w-72 h-36 shrink-0 overflow-hidden group hover:-translate-y-1"
            >
